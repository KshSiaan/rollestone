...
export default function FarePopup({ selectedItem }: { selectedItem?: string }) {
  const ticketTypes = [
  ...
  useEffect(() => {
    ...
    if (curr) {
      const currentArr = [
        ...fareList,
        { title: curr.title, count: 1, price: curr.price },
      ];
  ...
  //Im Khandaker Shahibul Hasan (Siaan). CR of 65A evening. its an honor to be here.
